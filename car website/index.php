    	...
    	<div class="row">
    		<div class="col-md-6">
    			<div class="about_taital">
    				<h1 class="about_text">About our SuPerCarWash</h1>
    		...
    		<div class="col-md-6">
    			<div class="about_img"><img src="images/blue-car.jpg"></div>
    		</div>
    	</div>
    </div>
    <!-- about section end -->
    ...
    <div class="our_section layout_padding">
    	<div class="container">
    		...
    		<div class="row padding_top_0">
    			<div class="col-lg-4">
    				<div class="image_7"><a href="#"><img src="images/car4.jpg"></a></div>
    				<h2 class="design_text">service1</h2>
    				<p class="fact_text">It is a long established fact that a reader will be distracted by the readable</p>
    			</div>
    		    <div class="col-lg-4">
    		    	<div class="image_7"><a href="#"><img src="images/car2.jpg"></a></div>
    				<h2 class="design_text">service2</h2>
    				<p class="fact_text">It is a long established fact that a reader will be distracted by the readable</p>
    		    </div>
    		    <div class="col-lg-4">
    		    	<div class="image_7"><a href="#"><img src="images/car3.jpg"></a></div>
    				<h2 class="design_text">service3</h2>
    				<p class="fact_text">It is a long established fact that a reader will be distracted by the readable</p>
    		    </div>
    		    <div class="bt_main">
    		    	<div class="seemore_bt"><a href="service.php">See More</a></div>
    		    </div>
    		</div>
            ...
            <div class="price_section_2">
            	<div class="row">
            		<div class="col-sm-12 col-lg-4">
            			<div class="beginner">
            				<h2 class="beginner_text">exterior washing</h2>
            				<h1 class="plan_text">R100</h1>
            				<P class="access_text">exterior washing</P>
            		
            				<P class="access_text">One Year memberships</P>
            				<P class="access_text">FREE drink package</P>
            		...
            		<div class="col-sm-12 col-lg-4">
            			<div class="premium">
            				<h2 class="beginner_text">interior washing</h2>
            				<h1 class="plan_text">R140</h1>
            				<P class="access_text">super wash</P>
            		...
            		<div class="col-sm-12 col-lg-4">
            			<div class="beginner">
            				<h2 class="beginner_text">full wash</h2>
            				<h1 class="plan_text">R400</h1>
            				<P class="access_text">full washing +spray</P>
    		...
    		<div class="col-md-6 background_bg">
    			<div class="contact_bg">
    				<div class="input_main">
                       <div class="container">
                       	<h2 class="request_text">CONTACT FORM</h2>
                          <form action="ContactDB.php" method="POST">
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="your name"  Name="fname" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="Phone" name="Phone" required>
                                ...
                                <input type="submit" class="send_bt"  name="submit" value="SEND">
