...
?>
    ...
    <div class="about_section_2 layout_padding">
        <div class="container">
            <h1 class="contact_text_2"><strong>BOOK FOR AN APPOINTEMENT</strong></h1>
    		...
    		<div class="col-md-6 background_bg">
    			<div class="contact_bg">
    				<div class="input_main">
                       <div class="container">
                       	<h2 class="request_text">Appointement form </h2>
                          <form action="bookingDB.php" method="POST">
                            ...
                            <div class="form-group">
                              <input type="date" class="email-bt" placeholder="date" name="date" required>
                            </div>
                            <div class="form-group">
                              <input type="time" class="email-bt" placeholder="time" name="time"required>
                            </div>
                                <input type="submit" class="send_bt"   name="submit" value="SEND" onclick="return alert('Are You Sure')">
